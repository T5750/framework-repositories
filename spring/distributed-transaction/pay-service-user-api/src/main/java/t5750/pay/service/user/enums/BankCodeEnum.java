...
public enum BankCodeEnum {
	ICBC("工商银行"), CMBCHINA("招商银行"), ABC("中国农业银行"), CCB("建设银行"), BCCB(
			"北京银行"), BOCO("交通银行"), CMBC("中国民生银行"), PINGANBANK("平安银行"), CIB(
					"兴业银行"), NJCB("南京银行"), CEB("光大银行"), BOC("中国银行"), CGB(
							"广发银行"), SHB("上海银行"), SPDB("上海浦东发展银行"), POST(
									"中国邮政"), CBHB("渤海银行"), HKBEA("东亚银行"), NBCB(
											"宁波银行"), ECITIC("中信银行"), BJRCB(
													"北京农村商业银行"), HXB(
															"华夏银行"), CZ(
																	"浙商银行"), HZBANK(
																			"杭州银行"), SRCB(
