package t5750.pay.service.trade.utils.alipay.config;
...
/**
 * 类名：AlipayConfigUtil 功能：基础配置类 详细：设置帐户有关信息及返回路径 版本：3.4 修改日期：2016-03-08 说明：
...
public class AlipayConfigUtil {
	...
	public static final String notify_url = (String) properties
			.get("notify_url");
	// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
	public static final String return_url = (String) properties
			.get("return_url");
	// 签名方式
	...
	public static final String input_charset = (String) properties
			.get("input_charset");;
	// 支付类型 ，无需修改
	public static final String payment_type = (String) properties
			.get("payment_type");;
	// 调用的接口名，无需修改
