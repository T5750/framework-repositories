package t5750.tcctransactionboot.sample.dubbo.redpacket.config;
...
public class TransactionAdviceConfig {
	private static final String AOP_POINTCUT_EXPRESSION = "execution(* t5750.tcctransactionboot.sample.dubbo.redpacket.service.*.*(..))";
	@Autowired
