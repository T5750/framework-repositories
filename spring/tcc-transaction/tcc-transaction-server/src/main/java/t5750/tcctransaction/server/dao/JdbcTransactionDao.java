...
import t5750.tcctransaction.server.vo.PageVo;
...
public class JdbcTransactionDao implements TransactionDao {
	...
	public List<TransactionVo> findTransactions(String domain, Integer pageNum,
		...
		try {
			...
			String sql = "select DOMAIN," + "GLOBAL_TX_ID,"
					+ "BRANCH_QUALIFIER," + "STATUS," + "TRANSACTION_TYPE,"
					+ "RETRIED_COUNT," + "CREATE_TIME,"
			...
			while (resultSet.next()) {
				...
				transactionVo.setGlobalTxId(DatatypeConverter
						.printHexBinary(resultSet.getBytes(2)));
				transactionVo.setBranchQualifier(DatatypeConverter
						.printHexBinary(resultSet.getBytes(3)));
