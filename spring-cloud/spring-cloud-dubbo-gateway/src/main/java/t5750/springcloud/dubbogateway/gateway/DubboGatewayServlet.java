package t5750.springcloud.dubbogateway.gateway;
...
public class DubboGatewayServlet extends HttpServletBean {
	...
	public void service(HttpServletRequest request,
		...
		RequestMetadata clientMetadata = buildRequestMetadata(request,
				restPath);
		DubboRestServiceMetadata dubboRestServiceMetadata = repository
				.get(serviceName, clientMetadata);
	...
	private RequestMetadata buildRequestMetadata(HttpServletRequest request,
			String restPath) {
		UriComponents uriComponents = fromUriString(request.getRequestURI())
				.build(true);
