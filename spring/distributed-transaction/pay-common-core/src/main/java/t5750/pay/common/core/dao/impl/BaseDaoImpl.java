package t5750.pay.common.core.dao.impl;
...
public abstract class BaseDaoImpl<T extends BaseEntity>
	...
	public int update(List<T> list) {
		...
		if (result <= 0) {
			throw BizException.DB_UPDATE_RESULT_0.newInstance(
					...
					getStatement(SQL_BATCH_UPDATE_BY_IDS));
		}
		return result;
	}
	...
	public int update(Map<String, Object> paramMap) {
		...
		if (result <= 0) {
			throw BizException.DB_UPDATE_RESULT_0.newInstance(
					...
					getStatement(SQL_BATCH_UPDATE_BY_COLUMN));
		}
		return result;
	}
	 ...
	 * 函数功能说明 ： 获取Mapper命名空间.
	 *
	 * @参数：@param sqlId @参数：@return @return：String @throws
	 */
