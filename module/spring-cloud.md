...
### Edgware
- [Spring Framework 4.3.19.RELEASE](https://spring.io/projects/spring-framework)
- [Spring Boot 1.5.16.RELEASE](https://spring.io/projects/spring-boot)
...
- [Spring Cloud Greenwich.SR5](https://spring.io/projects/spring-cloud)
- [Spring Cloud Alibaba 2.1.1.RELEASE](https://github.com/alibaba/spring-cloud-alibaba/tree/greenwich)
