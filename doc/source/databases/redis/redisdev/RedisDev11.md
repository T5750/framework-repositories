...
### 11.4　穿透优化
![redis-miss-min](https://s0.wailian.download/2018/10/29/redis-miss-min.png)
...
![redis-miss-null-min](https://s0.wailian.download/2018/10/29/redis-miss-null-min.png)
...
![redis-miss-bloomFilter-min](https://s0.wailian.download/2018/10/29/redis-miss-bloomFilter-min.png)
...
#### 1.串行命令
![redis-serialMget-min](https://s0.wailian.download/2018/10/29/redis-serialMget-min.png)
...
#### 2.串行IO
![redis-serialIOMget-min](https://s0.wailian.download/2018/10/29/redis-serialIOMget-min.png)
...
#### 3.并行IO
![redis-parallelIOMget-min](https://s0.wailian.download/2018/10/29/redis-parallelIOMget-min.png)
...
#### 4.hash_tag实现
![redis-hash-tag-node-min](https://s0.wailian.download/2018/10/29/redis-hash-tag-node-min.png)

Redis Cluster的hash_tag功能可以将多个key强制分配到一个节点上，`操作时间=1次网络时间+n次命令时间`。所有key属于node2节点。

![redis-hash-tag-min](https://s0.wailian.download/2018/10/29/redis-hash-tag-min.png)
...
### 11.6　雪崩优化
![redis-stampeding-herd-min](https://s0.wailian.download/2018/10/29/redis-stampeding-herd-min.png)
...
#### 1.互斥锁（mutex key）
![redis-setnx-min](https://s0.wailian.download/2018/10/29/redis-setnx-min.png)
...
#### 2.永远不过期
![redis-logicTimeout-min](https://s0.wailian.download/2018/10/29/redis-logicTimeout-min.png)
