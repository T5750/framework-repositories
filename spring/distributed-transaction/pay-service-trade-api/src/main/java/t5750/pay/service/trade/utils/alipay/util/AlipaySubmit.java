...
import t5750.pay.service.trade.utils.alipay.sign.MD5;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
		...
		if (AlipayConfigUtil.sign_type.equals("MD5")) {
			mysign = MD5.sign(prestr, AlipayConfigUtil.key,
					AlipayConfigUtil.input_charset);
		}
		return mysign;
	}
	...
	public static String query_timestamp() throws MalformedURLException,
		...
		String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner="
				+ AlipayConfigUtil.partner + "&_input_charset"
				+ AlipayConfigUtil.input_charset;
