package com.evangel.curator.ext;
...
/**
 * DiscoveryExample提供了增加，删除，显示，注册已有的服务的功能。注意此处服务注册是由ExampleServer自己完成的，
 * 这比较符合实际的情况。实际情况是服务自己起来后主动注册服务。但是此处启动又是由DiscoveryExample来调用，纯粹为了演示使用。
 * 你可以根据你自己的情况合理安排服务的注册和启动。<br/>
 * random命令提供了一个完全由DiscoveryExample控制的服务。它负责注册一个服务并启动。调用close就关闭了服务。
 */
