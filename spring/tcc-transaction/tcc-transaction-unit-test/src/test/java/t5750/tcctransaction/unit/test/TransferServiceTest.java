...
public class TransferServiceTest extends AbstractTestCase {
	...
	public void testTransfer() throws InterruptedException {
		...
		Assert.assertTrue(subAccountFrom.getStatus() == AccountStatus.NORMAL
				.getId());
		Assert.assertTrue(subAccountTo.getStatus() == AccountStatus.NORMAL
				.getId());
	...
	public void testTransferWithMultipleTier() {
		...
		Assert.assertTrue(accountRecordTo.getStatusId() == AccountStatus.NORMAL
				.getId());
	}
