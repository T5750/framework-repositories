package t5750.pay.service.accounting.dao.impl;
...
public class RpAccountingVoucherDaoImpl extends BaseDaoImpl<RpAccountingVoucher>
		implements RpAccountingVoucherDao {
	/**
	 * 创建会计分录原始凭证信息.
	 * 
	 * @param entryType
	...
	public String buildAccountingVoucherNo(int entryType) {
		return entryType + DateUtils.toString(new Date(), "yyyyMMdd")
				+ super.getSqlSession()
						.selectOne(getStatement("buildAccountingVoucherNo"));
	}
