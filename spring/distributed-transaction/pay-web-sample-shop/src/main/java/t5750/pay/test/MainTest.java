...
public class MainTest {
	public static void main(String[] args) {
		...
		listMerchantKey.add(new MerchantKey("4c52295065654407b42797cda80dd07d",
				"6606353e0dab4f7b9a723f2d3e3276b7"));// 商户1 bm
		listMerchantKey.add(new MerchantKey("abcf900288114d5fa7fde764966eb2ff",
				"d94d7c2d56eb4b06828cf746c8be17e6"));// 商户2 fs
//		listMerchantKey.add(new MerchantKey("8ba459f55ff04f39b0128a3cb4a48f2b",
//				"3e2ca2eb1f024570b241d65eb4832c37"));// 商户3 sh
//		listMerchantKey.add(new MerchantKey("93d1ea2f9f3b448994f39d6efc7746ef",
//				"fad7ea79810c4af7a973c091aa7c6143"));// 商户4 tc
//		listMerchantKey.add(new MerchantKey("ca6577dff6d647ac882dfb405ceda21e",
//				"1b8da6c9b7544856955fcff6bf920f84"));// 商户5 mk
		// listMerchantKey.add(new
		// MerchantKey("4c52295065654407b42797cda80dd07d",
		// "6606353e0dab4f7b9a723f2d3e3276b7"));//商户1 bm
		// listMerchantKey.add(new
		// MerchantKey("abcf900288114d5fa7fde764966eb2ff",
		// "d94d7c2d56eb4b06828cf746c8be17e6"));//商户2 fs
		// listMerchantKey.add(new
		// MerchantKey("8ba459f55ff04f39b0128a3cb4a48f2b",
		// "3e2ca2eb1f024570b241d65eb4832c37"));//商户3 sh
		// listMerchantKey.add(new
		// MerchantKey("93d1ea2f9f3b448994f39d6efc7746ef",
		// "fad7ea79810c4af7a973c091aa7c6143"));//商户4 tc
		// listMerchantKey.add(new
		// MerchantKey("ca6577dff6d647ac882dfb405ceda21e",
		// "1b8da6c9b7544856955fcff6bf920f84"));//商户5 mk
	...
	private static void testGateWayPay(String payKey, String paySecret) {
		...
		for (int i = 0; i < 1; i++) { // 每条线程生成数
			...
			String merchantOrderNo = "pt" + threadID + sdf.format(new Date())
					+ 000 + i; // 生成商户订单号
	...
	private static Map<String, Object> getNotifyRequestMap(String bankOrderNo) {
		...
		String timeEnd = new SimpleDateFormat("yyyyMMddhhmmss")
				.format(new Date());
	...
	private static Map<String, Object> getInitRequestMap(
		...
		paramMap.put("returnUrl",
				"http://127.0.0.1:8083/pay-web-sample-shop/microPayNotify/notify"); // 页面通知返回url
