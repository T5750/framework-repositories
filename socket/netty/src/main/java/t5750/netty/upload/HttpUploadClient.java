...
public final class HttpUploadClient {
	static final String BASE_URL = System.getProperty("baseUrl", "http://"
			+ NettyUtil.INET_HOST + ":" + NettyUtil.PORT_8765 + "/");
	static final String FILE = "D:" + File.separatorChar + "dubbox-master.zip";
	...
	public static void main(String[] args) throws Exception {
		...
		String scheme = uriSimple.getScheme() == null ? "http" : uriSimple
				.getScheme();
		String host = uriSimple.getHost() == null ? NettyUtil.INET_HOST
				: uriSimple.getHost();
		...
		try {
			...
			formpostmultipart(b, host, port, uriFile, factory, headers,
					bodylist);
		} finally {
	 ...
	 *         next post
	 */
	private static List<InterfaceHttpData> formpost(Bootstrap bootstrap,
	 ...
	 * Multipart example
	 */
	private static void formpostmultipart(Bootstrap bootstrap, String host,
			int port, URI uriFile, HttpDataFactory factory,
			List<Entry<String, String>> headers,
			List<InterfaceHttpData> bodylist) throws Exception {
